...
const UserNav = ({ username , useremail , useravatar }: { username :string | null | undefined , useremail : string | null | undefined , useravatar : string | null | undefined}) => {
  return (
    <div>
                            ...
                            <div className='bg-muted px-4 py-2 rounded-md flex items-center justify-center gap-2'>
                                ...
                                <DropdownMenu>
                                    ...
                                    <div className='h-7 w-7 overflow-hidden rounded-full outline-2 outline-zinc-900'>
                                         <Image  loading='lazy' src={useravatar} alt='U' height={"100"} width={"100"}/>
                                    </div>
                                    </DropdownMenuTrigger>
                                    <DropdownMenuContent className='w-40 py-2'>
                                        <DropdownMenuLabel className='px-4 font-semibold'>
                                            <div className='flex flex-col gap-0.5'>
                                                <div>{username}</div>
                                                <div className='text-[8px] text-muted-foreground font-light'>{useremail}</div>
